...
import { MenuConfig, Terminal } from "lib-common-angular";
import { MenuDemoVisualComponent } from './menu-demo-visual.component';

@Component({
  selector: 'app-menu-navigation',
  standalone: true,
  imports: [CommonModule, RouterModule, Terminal, MenuDemoVisualComponent],
...
`
 permisos : string = `
import { PermissionConfig } from 'lib-common-angular';
...
`
router : string = `export const routes: Routes = [ {
    path: '',
